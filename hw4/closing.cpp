...
int main()
{
	...
	for (int i = 0; i < img.rows; i++)          //use octagon kernel to erosion
	{
		for (int j = 0; j < img.cols; j++)
		{
			if (dil.at<uchar>(i, j) == 255)    //erosion to white pixel
			{
				flag = 0;
